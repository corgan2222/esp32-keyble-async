...
String ha_main_topic = "homeassistant";
String ha_device_topic = "esp32";
...
void firmwareUpdate()
{
    ...
    String firmwareUrl = Sprintf("https://github.com/corgan2222/ESP32-boilerplate/releases/latest/download/%s.bin", FIRMWARE);
...
void commonDiscovery(JsonDocument *doc)
{
    ...
    (*doc)["dev"]["name"] = ha_device_topic + "-" + room;
    (*doc)["dev"]["sa"] = room;
